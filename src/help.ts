export function helpText(): string {
  return [
    ...
    "  orchestrator candidates promotions <workspace>    # re-observes and names unsettled records",
    ...
    "  orchestrator candidates promotions <workspace> acknowledge --confirm <phrase>",
    "                                                    # shows how records that left 'applying' before this process",
    "                                                    # started would read once accepted; writes nothing, and does",
    "                                                    # NOT unblock a promotion (that runs in another process)",
