...
- 483/483 deterministic tests（2026-08-06，Phase 5-4 後）。
- 最新最終 gate：line 95.02%、branch 87.83%、functions 96.90%；gate 分別為 90%、85%、90%。
  branch 餘裕 2.83 個百分點；仍應假設任何新增分支都要同批補測試。
