...
- [ ] 2026-07-22 新增 room-first／seat-only 核准 UI 與 server 強制路由，277 項完整 gate 已通過；
  兩種 mode 的新版 Chrome 可視複驗仍待官方 Chrome app bundle 完整重裝。不得以 HTTP contract 或
  其他 browser automation 冒充這一項實機驗收。
